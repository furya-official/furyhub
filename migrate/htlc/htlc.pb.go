...
type OldHTLC struct {
	...
	State                HTLCStatus                               `protobuf:"varint,8,opt,name=state,proto3,enum=furymod.htlc.HTLCStatus" json:"state,omitempty"`
}
...
func init() {
	proto.RegisterEnum("furymod.htlc.HTLCStatus", HTLCStatus_name, HTLCStatus_value)
	proto.RegisterType((*OldHTLC)(nil), "furymod.htlc.OldHTLC")
}
