...
FURYhub metrics also contains tendermint metrics, Visit [tendermint metrics](https://github.com/furyaofficial/tendermint/blob/furyaofficial/master/docs/tendermint-core/metrics.md) for more information.
